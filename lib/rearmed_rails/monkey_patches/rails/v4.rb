enabled = RearmedRails.enabled_patches[:rails_4] == true

if defined?(ActiveRecord)

  ActiveRecord::Batches.module_eval do
    if enabled || RearmedRails.dig(RearmedRails.enabled_patches, :rails_4, :find_in_relation_batches)
    ...
    if enabled || RearmedRails.dig(RearmedRails.enabled_patches, :rails_4, :find_relation_each)
